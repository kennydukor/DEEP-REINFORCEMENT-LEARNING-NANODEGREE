...
from models_agent_py.models import Actor, Critic

class Agent():        
    def __init__(self, 
                 device, state_size, n_agents, 
                 action_size, random_seed, buffer_size, 
                 batch_size, gamma, TAU, lr_actor, 
                 lr_critic, weight_decay, checkpoint_dir = './'):        
        ...
        self.CHECKPOINT_FOLDER = checkpoint_dir
        ...
        if os.path.isfile(self.CHECKPOINT_FOLDER + 'checkpoint_actor.pth') and os.path.isfile(self.CHECKPOINT_FOLDER +
